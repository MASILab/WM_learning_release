...
def format(data_file,type):
    doc_dir = '/scratch/yangq6/learning/Tracula/doc'
    reco_tract_dir = '/scratch/yangq6/learning/Tracula/myData/output'
    data_list = np.loadtxt(data_file,dtype=str)
    with open(os.path.join(doc_dir,'{}_tracula.txt'.format(type)),'w') as f:
