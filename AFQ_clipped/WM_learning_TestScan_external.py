...
class TestScan(dataset):
    ...
    def _proc_doc(self):
        ...
        self.logger.info('The tract is {}'.format(self._tractID))
...
if __name__ == '__main__':
    ...
    tractID_file = '/scratch/yangq6/learning/AFQ_clipped/doc/AFQ_clippedID.txt'
    ...
    prepMerge('../pred_external',testScan.Get_scan_name(),testScan.Get_T1_file())
