...
def format(data_file,type):
    doc_dir = '/scratch/yangq6/learning/AFQ_clipped/doc'
    reco_tract_dir = '/scratch/yangq6/learning/AFQ_clipped/myData/output'
    data_list = np.loadtxt(data_file,dtype=str)
    with open(os.path.join(doc_dir,'{}_AFQ_clipped.txt'.format(type)),'w') as f:
