...
class TestScan(dataset):
    ...
    def _proc_doc(self):
        txt = np.loadtxt(options.test_list,dtype=str,ndmin=1)[self.ind]
...
if __name__ == '__main__':
    ...
    tractID_file = '/scratch/yangq6/learning/Xtract/doc/xtractID.txt'
    ...
    prepMerge('../pred_test',testScan.Get_scan_name(),testScan.Get_T1_file())
