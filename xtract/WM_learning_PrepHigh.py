...
class PrepHigh(object):
    ...
    def __init__(self,scan_name):
        ...
        self.tracts_dir = '/scratch/yangq6/learning/Xtract/myData/output'
        self.detail_dir = '/scratch/yangq6/learning/Xtract/doc/detail'
    ...
    def _io_check(self):
        if os.path.isdir(os.path.join(self.tracts_dir,self.scan_name)) and os.path.isfile(self.detail_file) and os.path.isfile(os.path.join(self.tracts_dir,self.scan_name,'{}_bin.nii.gz'.format(self.scan_name))):
            self.logger.info('*************************************')
