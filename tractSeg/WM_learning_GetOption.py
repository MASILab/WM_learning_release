...
def get_test_option(args=sys.argv[2:]):
    ...
    parser.add_argument("--test_list",     default='/scratch/yangq6/learning/TractSeg/doc/valid_tractSeg_HaveSkull.txt', type=str,help="which database we want to use")
...
def get_train_option(args=sys.argv[1:]):
    ...
    parser.add_argument("--model_prefix",      default=None  ,type=str, help="where need to save the model")
    parser.add_argument("--train_list",        default='../doc/train_tractSeg_HaveSkull.txt',type=str,help="which database we want to use")
    parser.add_argument("--valid_list",        default='../doc/valid_tractSeg_HaveSkull.txt', type=str,help="which database we want to use")
